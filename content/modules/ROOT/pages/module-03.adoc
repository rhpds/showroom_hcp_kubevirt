...
More information: https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.11/html/clusters/cluster_mce_overview#hosted-sizing-guidance

== Prerequisites


. Unset KUBERNETES_SERVICE_HOST (only needed on the web terminal)
+
...
----
oc login {openshift_api_server_url} --username={openshift_cluster_admin_username} --password={openshift_cluster_admin_password} --insecure-skip-tls-verify=true
----
...
[source,bash,role=execute,subs="attributes"]
----
curl -O https://hcp-cli-download-multicluster-engine.apps.cluster-{guid}.dynamic.redhatworkshops.io/linux/amd64/hcp.tar.gz
----
...
[source,bash,role=execute]
----
tar xvfz hcp.tar.gz -C /home/lab-user/bin/
----
...
[%nowrap]
----
Client Version: openshift/hypershift: c68950b6a4d2cc96cb42fb16c26da94dafa48891. Latest supported OCP: 4.16.0
Server Version: c68950b6a4d2cc96cb42fb16c26da94dafa48891
...
. Extract pull secret from the host cluster
+
[source,bash,role=execute]
----
...
== Review creation
[IMPORTANT]
Ignore the warning related to MTU. This environment is running under Virtualization, the MTU is set to 8950 instead the 9000 recommended.
...
console                                    4.16.15   True        False         False      16m     
csi-snapshot-controller                    4.16.15   True        False         False      24m     
dns                                        4.16.15   True        False         False      16m     
image-registry                             4.16.15   True        False         False      17m     
ingress                                    4.16.15   True        False         False      16m     
insights                                   4.16.15   True        False         False      18m     
kube-apiserver                             4.16.15   True        False         False      24m     
kube-controller-manager                    4.16.15   True        False         False      24m     
kube-scheduler                             4.16.15   True        False         False      24m     
kube-storage-version-migrator              4.16.15   True        False         False      18m     
monitoring                                 4.16.15   True        False         False      15m     
network                                    4.16.15   True        False         False      19m     
node-tuning                                4.16.15   True        False         False      20m     
openshift-apiserver                        4.16.15   True        False         False      24m     
openshift-controller-manager               4.16.15   True        False         False      24m     
openshift-samples                          4.16.15   True        False         False      16m     
operator-lifecycle-manager                 4.16.15   True        False         False      24m     
operator-lifecycle-manager-catalog         4.16.15   True        False         False      24m     
operator-lifecycle-manager-packageserver   4.16.15   True        False         False      24m     
service-ca                                 4.16.15   True        False         False      18m     
storage                                    4.16.15   True        False         False      24m  
----
...
cluster1-e8c8e8b9-bpkkp   Ready    worker   21m   v1.29.8+f10c92d
cluster1-e8c8e8b9-v76qk   Ready    worker   21m   v1.29.8+f10c92d
----
