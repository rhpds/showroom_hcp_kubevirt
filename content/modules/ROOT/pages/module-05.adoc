...
. Navigate to *Storage* -> *StorageClasses*. A storageclass named `lvms-<name>` is created automatically when a _LVMCluster_ is configured. In this cluster it is called `lvms-vg1`
+
