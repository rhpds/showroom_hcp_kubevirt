...
cluster1   cluster1   2               2               False         False        4.16.15  
----
...
cluster1-e8c8e8b9-bpkkp   26m   Running                   True
cluster1-e8c8e8b9-s6rvj   11s   WaitingForVolumeBinding   False
cluster1-e8c8e8b9-v76qk   26m   Running                   True
----
...
cluster1-e8c8e8b9-bpkkp   Ready    worker   37m   v1.29.8+f10c92d
cluster1-e8c8e8b9-s6rvj   Ready    worker   10m   v1.29.8+f10c92d
cluster1-e8c8e8b9-v76qk   Ready    worker   37m   v1.29.8+f10c92d
----
+
[NOTE]
...
----
NAME                      AGE    STATUS        READY
cluster1-e8c8e8b9-v76qk   100m   Terminating   False
cluster1-e8c8e8b9-bpkkp   100m   Running       True
cluster1-e8c8e8b9-s6rvj   17m    Running       True
----
...
----
NAME                      AGE   STATUS    READY
cluster1-e8c8e8b9-bpkkp   46m   Running   True
cluster1-e8c8e8b9-s6rvj   19m   Running   True
----
...
----
NAME                      AGE    STATUS    READY
cluster1-e8c8e8b9-56lbs   3m1s   Running   True
cluster1-e8c8e8b9-bpkkp   50m    Running   True
cluster1-e8c8e8b9-hg8tr   3m1s   Running   True
cluster1-e8c8e8b9-s6rvj   24m    Running   True
cluster1-e8c8e8b9-w5nt7   3m1s   Running   True
----
...
----
NAME                           STATUS   ROLES    AGE    VERSION
node/cluster1-e8c8e8b9-56lbs   Ready    worker   118s   v1.29.8+f10c92d
node/cluster1-e8c8e8b9-bpkkp   Ready    worker   48m    v1.29.8+f10c92d
node/cluster1-e8c8e8b9-hg8tr   Ready    worker   110s   v1.29.8+f10c92d
node/cluster1-e8c8e8b9-s6rvj   Ready    worker   21m    v1.29.8+f10c92d
node/cluster1-e8c8e8b9-w5nt7   Ready    worker   98s    v1.29.8+f10c92d

NAME                               READY   STATUS    RESTARTS   AGE
pod/reversewords-f4c789568-55cnq   1/1     Running   0          5m35s
pod/reversewords-f4c789568-d6pb6   1/1     Running   0          5m35s
pod/reversewords-f4c789568-fdjzf   1/1     Running   0          5m35s
pod/reversewords-f4c789568-jwxhh   1/1     Running   0          5m35s
pod/reversewords-f4c789568-lfj5b   1/1     Running   0          5m36s
pod/reversewords-f4c789568-ws7vz   1/1     Running   0          5m35s
----
